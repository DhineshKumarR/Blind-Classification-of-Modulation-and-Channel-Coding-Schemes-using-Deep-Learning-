...
%          interleaved_bits = coded_bits(inter_index);
 ...
 CH1_1 = [CH1; zeros(1,10000)] ;
 CH1_2 = [CH1_1; zeros(1,10000)] ;
%  CH1_2 = [CH1_2; zeros(1,10000)] ;
%  CH1_2 = [CH1_2; ones(1,10000)] ;
 CH1_2 = [CH1_2; ones(1,10000)] ;
...
%          interleaved_bits = coded_bits(inter_index);
  ...
  CH2_1 = [CH2; ones(1,10000)] ;
  CH2_2 = [CH2_1; ones(1,10000)] ;
%   CH2_2 = [CH2_2; ones(1,10000)] ;
%   CH2_2 = [CH2_2; zeros(1,10000)] ;
  CH2_2 = [CH2_2; zeros(1,10000)+2] ;
  %% Shuffling
  CH_2 = [CH1_2  CH2_2];
...
RX1_12 = [RX12; zeros(1,10000)] ;
RX1_23 = [RX23; ones(1,10000)] ;
RX1_12(18,:) = ~ RX1_12(17,:);
RX1_12(19,:) =  RX1_12(18,:)+2;
% RX1_12(20,:) =  RX1_12(19,:);
% RX1_12(21,:) =  RX1_12(20,:)+3;
RX1_23(18,:) = ~ RX1_23(17,:);
RX1_23(19,:) =  RX1_23(18,:)+4;
% RX1_23(20,:) =  RX1_23(19,:);
...
traindata_dc_7dB_10000 = TXC_U;
save('traindata_dc_7dB_10000','traindata_dc_7dB_10000'); 