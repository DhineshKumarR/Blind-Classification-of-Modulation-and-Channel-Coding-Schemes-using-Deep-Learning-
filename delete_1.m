...
%%----------neural network------------------------------------
net = NeuralNet2([numFeatures 256 256 128 numClasses]); % Create Neural Network object
...
load('testdata_dc2_25dB_100.mat');
test = testdata_dc2_25dB_100([1:16],:);
test = test';
